...
saveOnList = fetchSaveOnMain(query)
walmartList = fetchWalmartMain(query)
...
groupList = compare(safewayList, superstoreList, noFrillsList, igaList, walmartList, saveOnList, query)
